...
function placeXOrO(squareNumber) {
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))){
        ...
        if (activePlayer === 'X') {
            //If active player is equal to X than x.png is placed in HTML
...
//drawWinLine function is called to draw line if conidition is met.
function checkWinConditions () {
    ...
    //This function checks if any array includes 3 strings. It used to check for
    //each win conditin.
...
//This function takes a string parameter of the path of the path you set earlier for
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    //This line indicates where the start of a lies x axis is.
    let x1 = coordX1,
        ...
        x = x1,
        //This variable stores temporary y axis we data we update in our animation loop.
        y = y1;
    ...
    function animateLineDrawing () {
        ...
        //This is necessary for the 6, 2, 2 win condition
        if (x1 <=x2 && y1 >= y2) {
            if (x < x2) { x += 10; }
            if (y > y2) { y -= 10;}
            if (x >= x2 && y <= y2) { cancelAnimationFrame(animationLoop);}
...
//This function resets the game in event of a toe or a win.
function resetGame() {
